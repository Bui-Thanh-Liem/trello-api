// Xử lý lỗi tập trung next('message') -> use
// Thay vì chổ nào có lỗi cũng phải khai báo lỗi ra (res.status(500).json(error: error.message))
// Thì làm 1 nơi để xử lý tất cả lỗi rồi dùng next() để chuyển về nơi sử lý lỗi chung này
// Có 3 loại thông báo lỗi: node, custom of node, joi
